...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(edu.unicundi.controller.ConsultaExamenController.class);
        resources.add(edu.unicundi.controller.DetalleConsultaController.class);
        resources.add(edu.unicundi.controller.ExamenController.class);
        resources.add(edu.unicundi.controller.MedicoController.class);
