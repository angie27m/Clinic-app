...
public class DetalleConsulta implements Serializable{
    ...
    @Size(min = 3, max = 49,  message = "Diagnostico debe estar entre 3 y 50 caracteres")    
    @Column(name = "diagnostico", nullable = false, length = 25)
    private String  diagnostico;
    
    @NotNull(message = "Tratamiento es requerido")
    @Size(min = 3, max = 49,  message = "Tratamiento debe estar entre 3 y 50 caracteres")    
